...
impl<E> LookupTable<E> {
    ...
    pub fn new(GLOBAL: &'static StatsAlloc<System>, keys: &[u16], objects: Box<[E]>) -> Self {
        ...
        HASH_MAPS_IN_BYTES.fetch_add(change.bytes_current_used + std::mem::size_of_val(&res), Ordering::SeqCst);
        res
    }
