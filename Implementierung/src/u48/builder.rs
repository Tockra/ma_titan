...
use crate::u48::stat::{L2Ebene, L3Ebene};
...
pub struct BuilderLevel<T> {
    ...
    /// Speichert die L2-, bzw. L3-Top-Tabelle, welche 2^12 (Bits) besitzt. Also [u64;2^12/64]. 
...
/// Annahme: Größe des lx_top-Arrays 2^12 Elemente
/// 
/// # Arguments
///
