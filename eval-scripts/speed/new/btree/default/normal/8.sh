...
#SBATCH --output=/work/smtitann/output/speed/new/btree_normal_8_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release btree new $2 normal 8 $3
