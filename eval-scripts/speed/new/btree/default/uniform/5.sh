...
#SBATCH --output=/work/smtitann/output/speed/new/btree_uniform_5_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release btree new $2 uniform 5 $3
