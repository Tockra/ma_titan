...
#SBATCH --output=/work/smtitann/output/speed/new/stree_%x_normal_26_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release stree new $2 normal 26 $3