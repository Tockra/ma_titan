...
#SBATCH --output=/work/smtitann/output/speed/new/binary_normal_27_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release binary new $2 normal 27 $3
