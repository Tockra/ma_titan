...
#SBATCH --output=/work/smtitann/output/speed/pred/binary_normal_6_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release binary pred $2 normal 6 $3