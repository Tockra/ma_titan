...
#SBATCH --output=/work/smtitann/output/speed/pred/stree_%x_bwt_runs_32_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release stree pred $2 bwt_runs 32 $3
