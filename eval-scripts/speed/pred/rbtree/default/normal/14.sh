...
#SBATCH --output=/work/smtitann/output/speed/pred/rbtree_normal_14_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release rbtree pred $2 normal 14 $3
