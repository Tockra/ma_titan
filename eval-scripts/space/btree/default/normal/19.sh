...
#SBATCH --output=/work/smtitann/output/space/btree_normal_19_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release btree $2 normal 19 $3
