...
#SBATCH --output=/work/smtitann/output/space/binary_normal_23_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release binary $2 normal 23 $3
