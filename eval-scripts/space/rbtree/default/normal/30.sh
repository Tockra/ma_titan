...
#SBATCH --output=/work/smtitann/output/space/rbtree_normal_30_%j.dat # The location, where all output is collected. %j will be replaced with the job id.
cd $1 # Go to the directory, where the executable is stored.
cargo run --release rbtree $2 normal 30 $3
